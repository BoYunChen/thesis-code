...
option1 = odeset('Mass',A,'AbsTol',3e-4,'RelTol',3e-2);
[t, y]= ode15s(@PNP1D, [0 T1], y,options);
[t1, y1] = ode15s(@PNP1D2,[0 T2],y(end,:),option1);
